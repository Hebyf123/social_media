    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_online', models.DateTimeField(blank=True, null=True, verbose_name='Последний раз в сети')),
                ...
                ('hashtags', models.ManyToManyField(blank=True, related_name='users', to='usersmodel.hashtag')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='usersmodel.chat')),
